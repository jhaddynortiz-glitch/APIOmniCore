...
let AuthController = class AuthController {
    ...
    async switchOrganization(req, organizationId) {
...
__decorate([
    (0, common_1.Get)('migrate-contacts'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "migrateContacts", null);
__decorate([
    (0, common_1.Get)('clear-chats'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "clearChats", null);
__decorate([
